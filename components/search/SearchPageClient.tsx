...
export function SearchPageClient() {
  ...
  return (
    <div className="mt-10">
      <form onSubmit={submitSearch} role="search" className="border-y border-white/[0.08] py-5">
        <label htmlFor="search-page-input" className="mb-2 block text-xs text-zinc-500">搜索 ClutchNest 内容</label>
        <div className="flex flex-col gap-2 sm:flex-row">
          ...
          <button type="submit" className="btn-primary min-h-12 px-6">搜索</button>
        </div>
      </form>
