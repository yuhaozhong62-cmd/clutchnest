...
export default function CrosshairNotFound() {
  return (
    <div className="mx-auto flex min-h-[62vh] max-w-6xl items-center px-5 py-16">
      <div className="w-full border-y border-white/10 py-14 sm:py-20">
        ...
        <Link
          href="/crosshairs"
          className="mt-7 inline-flex items-center gap-2 rounded-md border border-white/15 px-4 py-2.5 text-sm font-semibold text-white transition hover:border-white hover:bg-white hover:text-black focus:outline-none focus:ring-2 focus:ring-white/30"
        >
